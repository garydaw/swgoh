...
export default function CharacterImage({character, centreImage = "true"}) {
  ...
  return (
    ...
    <div className={css.relative}>
      ...
      {character.zeta_abilities !== null && character.zeta_abilities != "" && <div className={`${css.CharacterImageOverlay} ${css.zetaOverlay}`}>{character.zeta_abilities.split(",").length}</div>}
      {character.omicron_abilities !== null && character.omicron_abilities != "" && <div className={`${css.CharacterImageOverlay} ${css.omicronOverlay}`}>{character.omicron_abilities.split(",").length}</div>}
    </div>
    </div>
  )
}
